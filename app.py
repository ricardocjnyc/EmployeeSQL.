# -*- coding: utf-8 -*-
"""
Created on Thu Jan 15 15:46:18 2020
...
def welcome():
     ...
     return (
         ...
         f"- Dates and temperature observations from the previous year<br/>"
         f" <br/>"
         ...
         f"/api/v1.0/<start><br/>"
         f"- Minimum temperature, the average temperature, and the max temperature for a given start day. Example:  /api/v1.0/2016-08-24 <br/>"
         f" <br/>"
         
         f"/api/v1.0/<start>/<end><br/>"
         f"- Minimum temperature, the average temperature, and the max temperature for a given range of days. Example:  /api/v1.0/2016-08-24/2016-08-26 <br/>"     
    )
...
def temperature_tobs():
    results = session.query(Station.name, Measurement.date, Measurement.tobs).\
        filter(Measurement.date >= "2016-01-01", Measurement.date <= "2018-01-01").\
        all()
